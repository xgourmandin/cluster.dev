...
require (
	...
	github.com/hashicorp/terraform-provider-kubernetes v1.13.4 // direct
...
replace github.com/hashicorp/terraform-provider-kubernetes => github.com/romanprog/terraform-provider-kubernetes v0.0.3
